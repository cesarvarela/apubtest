      ...
      <div className="w-full max-w-5xl space-y-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Transform JSON-LD structures into normalized entities with bidirectional relationships for analysis
            </p>
            <Link
              href="/demos/normalization"
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              Dynamic Chart Wizard
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Create charts from any JSON-LD data using a guided wizard that dynamically discovers entity types and relationships
            </p>
            <Link
              href="/demos/dynamic-charts"
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Create and manage multiple charts in a dashboard interface. Build custom visualizations from JSON-LD data
            </p>
            <Link
              href="/demos/chart-dashboard"
