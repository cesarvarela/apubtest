...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        // Ensure the @id is preserved from the existing incident
        body["@id"] = (existingIncident.data as any)["@id"] || existingIncident.uri;
        body["@type"] = "Incident";
        
        // Validate the updated incident
        try {
        ...
        // Update the incident using the database ID
...
export async function DELETE(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        // Delete the incident using the database ID
